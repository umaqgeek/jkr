...
$(document).ready(function() {
	...
	$(".buang").click(function() {
		...
		$.get('<?=site_url('jurutera/partdelete'); ?>/'+idd);
		$("#tr1_"+idd).remove();
		$("#tr2_"+idd).remove();
		$("#tr3_"+idd).remove();
	});
	...
	$(".buang2").click(function() {
		var idd = $(this).attr("item");
		$.get('<?=site_url('jurutera/servicedelete'); ?>/'+idd);
		$("#tr21_"+idd).remove();
	});
});
</script>
...
<div class="row-fluid">
 ...
 <div class="row-fluid">
		...
		<div class="span9">
				  <form class="form-horizontal" id="form1" name="form1" method="post" action="<?=site_url('jurutera/notamintaedit');?>">
                  ...
                  <div class="control-group">
                    ...
                    <?php if($this->uri->segment(3)) { ?>
                    		...
                    		<input type="hidden" value="<?=$broken_log[0]->bl_id; ?>" name="bl_id" id="bl_id" />
                    <?php } else { ?>
                    ...
                    <?php } ?>
                      ...
                      <button type="button" class="btn lihatlog" url="<?=site_url('jurutera/getLog'); ?>">Lihat Log</button>
